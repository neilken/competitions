# BirdCLEF+ 2026 Competition Details
...
Please see the Code Competition FAQ for more information on how to submit. Review the code debugging documentation if you encounter submission errors.
...
Compiling this extensive dataset was a major undertaking, and the organizers thanked the many domain experts who helped collect and manually annotate the data for this competition. Specifically acknowledged were the following institutions and contributors:
...
- Xeno-canto: Willem-Pier Vellinga and Bob Planque
